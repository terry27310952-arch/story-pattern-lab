...
- red flag → 이상 신호 / 찝찝한 포인트 / 이건 좀 걸리는 지점
...
- closet / closeted → 아직 밝히지 않은 상태 / 주변에 말하지 않은 상태 / 본인이 숨기고 있던 부분
...
- alpha male → 상남자 이미지에 집착하는 사람 / 센 척하는 남성성 캐릭터 / 알파메일 분위기에 취한 사람
"""
...
3. 한국어권에서 실제로 쓰는 말인지 확인한다. 어색하면 단어 하나로 옮기지 말고 문장으로 푼다.
