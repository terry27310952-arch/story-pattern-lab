...
class StoryV9Test(unittest.TestCase):
    ...
    def test_excel_contains_v9_qa_and_previews(self) -> None:
        result = story_content_pipeline_v4.generate_story_package(
            [RIOT], 7, {"provider": story_content_pipeline_v4.PROVIDER_LOCAL}, generation_seed="v9-excel"
        )
        ...
        self.assertTrue(any("story-content-v9.0" in str(v) for v in context_values))
